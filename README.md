...
- به‌روزرسانی‌های روزانه: اسکریپت‌های خودکار روزانه داده‌ها را بررسی می‌کنند و از به‌روز بودن پیکربندی‌ها و قوانین اطمینان حاصل می‌کنند.
- دسته‌بندی دقیق: عدم وجود درهم‌ریختگی، ارائه منطق دسته‌بندی واضح برای پاسخگویی به نیازهای متنوع.
- منبع شفاف: داده‌ها از جامعه متن‌باز سرچشمه می‌گیرند، منابع با کیفیت بالا را ادغام می‌کنند و یک تجربه تمیز و بدون در پشتی را تضمین می‌کنند.(./THEDOC/CREDITS.md)。
- خارج از چارچوب: برای مبتدیان بهینه شده است، نیازی به پیکربندی پیچیده ندارد؛ برای لذت بردن از یک تجربه روان، کافیست داده‌ها را وارد کنید.
...
<table width="100%">
    <tr>
        <td width="25%" align="center">
            <h3>📖 مستندات کاربر</h3>
            <p>یک راهنمای جامع از دانلود تا تکنیک‌های پیشرفته.</p>
